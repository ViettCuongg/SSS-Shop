...
let product__sale = document.getElementById("grid__row__sale");
let shopItemsData__sale = [
    {
        id: "item1",
        name: "Basic-TShirt",
        oldPrice: "100.000đ",
...
let genneraeShop__sale = () => {
    return (product__sale.innerHTML = shopItemsData__sale.map((items) => {
        let { id, name, oldPrice, newPrice, brand, origin, sale, img, sold } = items;
        return `
    <div class="grid__column-2-4 " id=product__id-${id}>
    <a class="home-product-item" href="product_detail.html">
